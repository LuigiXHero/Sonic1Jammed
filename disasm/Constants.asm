...
vram_text2:		equ $D000	; level select text graphics
...
sizeof_art_text2:	equ filesize("Graphics\Sonic 2 Menu Text.bin")
...
; Options
	rsreset
bit_Spindash		rs.b	1		; %00000001 = Spindash
bit_TimeOver		rs.b	1		; %00000010 = TimeOver
bit_SpikeBug		rs.b	1		; %00000100 = Spike Bug
bit_EasyOrder		rs.b	1		; %00001000 = EasyOrder

; Difficulty
	rsreset
diff_Original		rs.b	1
diff_Easy		rs.b	1
diff_Normal		rs.b	1
diff_Rev00		rs.b	1
diff_Rev01		rs.b	1
...
ost_sonic_spindash:	equ $39 ; 1 if Sonic is spindashing

ost_sonic_spindash_charge:	equ $3A ; time until level restarts (2 bytes)
...
SRAM_End			EQU	SRAM_Start+$10000
SRAM_Unlock			EQU	$A130F1
