...
ObjPos_Diff_Index:
		dc.l ObjPos_OriginalIndex
		dc.l ObjPos_EasyIndex
		dc.l ObjPos_NormalIndex
		dc.l ObjPos_REV00Index
		dc.l ObjPos_REV01Index 	; The same as original besides one object in SLZ2
...
OPL_Init:
		...
		move.b	(v_difficulty).w,d1			; SonicJam get game difficulty
		lsl.b	#6,d0
		lsr.w	#4,d0					; combine zone/act into single number, times 4
		add.w	d1,d1
		add.w	d1,d1
		movea.l	ObjPos_Diff_Index(pc,d1.w),a0		; ^
