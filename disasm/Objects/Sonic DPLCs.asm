...
SonPLC_frame_WaterSlide:
		...
		dc.w $F4F6, $2506
	@end:
SonPLC_frame_spindash1:	
		dc.b (@end-SonPLC_frame_spindash1-1)/2
		dc.w $F510
	@end:
SonPLC_frame_spindash2:	
		dc.b (@end-SonPLC_frame_spindash2-1)/2
		dc.w $F520
	@end:
SonPLC_frame_spindash3:	
		dc.b (@end-SonPLC_frame_spindash3-1)/2
		dc.w $F530
	@end:
SonPLC_frame_spindash4:	
		dc.b (@end-SonPLC_frame_spindash4-1)/2
		dc.w $F540
	@end:
SonPLC_frame_spindash5:	
		dc.b (@end-SonPLC_frame_spindash5-1)/2
		dc.w $F550
	@end:
SonPLC_frame_spindash6:	
		dc.b (@end-SonPLC_frame_spindash6-1)/2
		dc.w $F560
	@end:
		even
