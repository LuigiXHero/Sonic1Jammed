...
Map_Sonic:	index *,,
		...
		ptr frame_spindash1,sonic_frames
		ptr frame_spindash2,sonic_frames
		ptr frame_spindash3,sonic_frames
		ptr frame_spindash4,sonic_frames
		ptr frame_spindash5,sonic_frames
		ptr frame_spindash6,sonic_frames
...
frame_WaterSlide:	spritemap
		...
		piece	$C, -8, 1x3, $10
		endsprite
frame_spindash1:	spritemap
		piece -12, -8, 4x4, 0
		endsprite
frame_spindash2:	spritemap
		piece -12, -8, 4x4, 0
		endsprite
frame_spindash3:	spritemap
		piece -12, -8, 4x4, 0
		endsprite
frame_spindash4:	spritemap
		piece -12, -8, 4x4, 0
		endsprite
frame_spindash5:	spritemap
		piece -12, -8, 4x4, 0
		endsprite
frame_spindash6:	spritemap
		piece -12, -8, 4x4, 0
		endsprite
		even