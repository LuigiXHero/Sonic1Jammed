...
v_ost_all:			rs.b sizeof_ost*countof_ost ; $FFFFD000 ; object variable space ($40 bytes per object; $80 objects) ($2000 bytes)
	...
	v_ost_titlemenu:	equ v_ost_all+(sizeof_ost*6) ; title screen sprite mask
	; Intro/credits
	...
	spindash_obj:		equ v_ost_all+(sizeof_ost*$7F) ; $1FC0 spindust
...
options_mode			rs.b 1 ; $FFFFFF86
v_difficulty:			rs.b 1 ; $FFFFFF87 ; SonicJam Difficulty Selection
v_options:			rs.b 1 ; $FFFFFF88
v_titlemenu:			rs.b 1 ; $FFFFFF89
v_titleprog:			rs.b 1 ; $FFFFFF8A
v_spindashlast:			rs.b 1 ; $FFFFFF8B
v_spindashtimer:		rs.b 1 ; $FFFFFF8C
v_spindashpitch:		rs.b 1 ; $FFFFFF8D
v_jamgamemode:			rs.b 1 ; $FFFFFF8E
unused_ff86:			rs.b $31
...
hscroll_delay			rs.w 1	;$FFFFC900
vscroll_delay			rs.w 1	;$FFFFC902
unused_ffc4:			rs.b $18
; Note: These were allocated outside of the Genesis RAM section in the original
;spindash_on	EQU	$FFFFC904	v_options for this
;game_mode	EQU	$FFFFC906	v_difficulty for this
